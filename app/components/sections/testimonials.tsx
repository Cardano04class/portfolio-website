...
const testimonials = [
    {
        ...
        image: "👩‍💼",
        content: "Mohamed is an exceptional developer who consistently delivers high-quality work. His attention to detail and problem-solving skills are outstanding. He transformed our application's performance significantly.",
        rating: 5
    },
    {
        name: "Michael Chen",
        ...
        image: "👨‍💻",
        content: "Working with Mohamed was a pleasure. He's not just a developer but a true problem solver. His ability to understand complex requirements and translate them into elegant solutions is remarkable.",
        rating: 5
    },
    {
        ...
        company: "StartupHub",
        image: "👩‍🎨",
        content: "Mohamed's technical expertise combined with his understanding of user experience makes him an invaluable team member. He brings ideas to life beautifully and efficiently.",
        rating: 5
    },
    {
        name: "David Thompson",
        ...
        company: "Tech Innovations Inc.",
        image: "👨‍🔧",
        content: "Mohamed is a mentor to junior developers and always willing to share knowledge. His code quality and architectural decisions have significantly improved our codebase.",
        rating: 5
    }
];
